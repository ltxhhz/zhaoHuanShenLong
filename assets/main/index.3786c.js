window.__require = function e(t, a, i) {
    ...
    if (!a[s]) {
      if (!t[s]) {
        ...
        if (r = r[r.length - 1], !t[r]) {
          ...
          if (!c && h) return h(r, true);
          if (n) return n(r, true);
    ...
    function (e, t) {
      ...
      var a = {
        ...
        closeUIAni: function (e, t, a, i) {
          void 0 === a && (a = .2), e.runAction(cc.fadeOut(a)), t.runAction(cc.sequence(cc.scaleTo(a, 0).easing(cc.easeBackIn()), cc.callFunc(i), cc.removeSelf(true)))
        },
        ...
        jumpByDegressAni: function (e, t, a, i, o, n) {
          ...
          var s = cc.misc.degreesToRadians(t),
            ...
            r = i / o;
          e.runAction(cc.sequence(cc.delayTime(n), cc.jumpBy(r, cc.v2(1.5 * c.x, a), i, 1), cc.removeSelf(true)))
        },
        moveDegressAni: function (e, t, a, i, o, n) {
          ...
          var s = cc.misc.degreesToRadians(t),
            ...
            h = o ? 0 : e.scale,
            l = n ? 0 : e.opacity;
          e.runAction(cc.sequence(cc.spawn(cc.scaleTo(r + .1, h), cc.moveBy(r, c).easing(cc.easeQuadraticActionOut()), cc.fadeTo(r + .1, l)), cc.fadeOut(.1), cc.removeSelf(true)))
        },
        ...
        o = ((a = {
          ...
          if (404 != this.req.status) {
            if (4 == this.req.readyState && this.req.status >= 200 && this.req.status <= 207 && this.req.responseText) {
              ...
              this.isBusy = false, this.perform.target ? this.perform.func.call(this.perform.target, e.error, e.data, e.commendGame, e.gameInfo) : this.perform.func(e)
            }
          } else {
            var t = i.launchScene,
              a = i.Bros;
          ...
          cc.log("网络错误"), this.isBusy = false, this.perform.target ? this.perform.func.call(this.perform.target, -1) : this.perform.func(-1)
        }, a.onTimeoutHandler = function () {
          cc.log("请求超时"), this.isBusy = false, this.perform.target ? this.perform.func.call(this.perform.target, -1) : this.perform.func(-1)
        }, a.clearAll = function () {
    ...
    function (e, t) {
      ...
      var a = {
        goToCover: function (e, t, a, i, o) {
          var n = e;
          n = null == n || null == n || e, console.log("LoadBoolBeforeLoadS", n), this.needShow = false, n && n ? (this.needShow = true, showMyAds()) : this.needShow = false, this.needShow ? (null == preloader && this.startGoToGame(a, i, o), resCompleteFlag = true, adCompleteFlag && resCompleteFlag && this.startGoToGame(a, i, o)) : this.startGoToGame(a, i, o)
        },
    ...
    function (e, t) {
      ...
      e("../MainManage").endHttpShowInfo, cc.Class({
        ...
        onLoad: function () {
          ...
          this.CreateEnemy(ltOpt.change ? ltOpt.enemyNum : 60)
          this.waterCount = 0
          this.randnum = 10
          this.angle = 0
          this.rotSpeed = 1500
        ...
        getCreatePos: function (e, t) {
          ...
          var a = e.width,
            i = e.height,
            o = s.getRandomNum(-a / 4, a / 4, false),
            n = s.getRandomNum(-i / 4, i / 4, false),
            c = cc.v2(o + e.x, n + e.y),
        ...
        CreateLeaf: function (e, t) {
          for (var a = 0; a < e; a++) {
            var i = cc.instantiate(this.leafPre),
              o = s.getRandomNum(1, 2, true),
              n = s.getRandomNum(1, 2, false) * this.SizeScale;
            i.scaleX = n, i.scaleY = n, i.angle = s.getRandomNum(-30, 30, false), ToolsJs.setTexture(i, "leaf" + o), this.leafNode.addChild(i);
        ...
        createMap: function () {
          ...
          var t = this.enemyNode.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(this.playerNode.position)),
            a = s.getRandomNum(this.gameWidth / 3, 3 * this.gameWidth / 4, false),
            i = 360 * Math.random(),
        ...
        getEnemyPos: function (e, t) {
          if (void 0 === t && (t = 0), !this.gameOverFlags) {
            var a = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio,
              ...
              c = s.getRandomNum(-o, o, false),
              r = s.getRandomNum(-n, n, false),
              h = cc.v2();
            ...
            if (this.firstFlags) {
              var g = s.getRandomNum(2 * -this.gameHeight, 2 * this.gameHeight, false),
                p = s.getRandomNum(2 * -this.gameHeight, 2 * this.gameHeight, false);
        ...
        getEnemyID: function (e) {
          var t = s.getRandomNum(0, 100, false),
            a = 0;
          if (1 == e) {
            if (t < 50) {
              a = 0
            ...
            if (t < 20) a = 0
            else if (t > 25 && t < 50) a = 1
            else if (t > 50 && t < 70) a = 2
            else a = 3
          } else if (3 == e) {
            if (t < 20) a = 0
            else if (t < 35) a = 1
            ...
            } else if (this.jiaoNum < 2) {
              a = 8
              this.jiaoNum++
            } else {
              if (this.jingyuNum < 3) a = 7
              else a = 6
            }
          } else if (7 == e) {
            if (t <= 20) a = 3
              ...
              if (this.jingyuNum < 5) {
                ...
                if (this.jiaoNum < 5) {
                  a = 8, this.jiaoNum++
                } else a = s.getRandomNum(3, 4, true)
              }
            }
          } else if (8 == e) {
            if (t < 40) a = 3
              ...
              this.jingyuNum < 3 && (a = 7, this.jingyuNum++)
            } else {
              if (this.jiaoNum < 3) {
                a = 8, this.jiaoNum++
              } else a = s.getRandomNum(4, 5, true)
            }
          } else {
            a = s.getRandomNum(3, 5, true)
          }
          if (e >= 4 && a == e - 1) return this.getEnemyID(e)
          else return a
        },
        CreateEnemy: function (e) {
          for (var t = 0; t < e; t++) {
            var a = t <= .8 * e ? 0 : t <= .9 * e ? 1 : 2; //敌人数组索引
            if (ltOpt.change) {
              a = t <= ltOpt.initScale[0] * e ? 0 : t <= ltOpt.initScale[0] + ltOpt.initScale[1] * e ? 1 : 2
            }
            if (ltOpt.safeMode) {
              a = 0
            }
            ...
            if (ltOpt.godView.enable) {
              ...
              if (ltOpt.godView.normalSpeed) {
                o = ltOpt.normalCameraZoom[0]
              }
            }
            i.speed = (200 - 15 * i.typeID) / o;
            var n = this.getEnemyPos(i);
            n ? (this.enemyNode.addChild(i, 1), i.setPosition(n), i.getComponent("enemyJS").active = true, this.enemyAction(i)) : i.destroy()
          }
        ...
        CreateSingleEnemy: function (e, playerLevel) {
          if (!this.gameOverFlags) {
            var a = this.enemyNode.children.length,
              playerLevel1 = this.playerNode.typeID;
            if (playerLevel1 <= 3) {
            ...
            for (var o = 0; o < e; o++) {
              ...
              var s = cc.instantiate(this.enemyPreArr[n]);
              this.changeSize(s)
              s.typeID = n + 1;
              var c = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio;
              if (ltOpt.godView.enable && !ltOpt.godView.normalSpeed) {
                c = ltOpt.normalCameraZoom[playerLevel1 - 1]
              }
        ...
        enemyAction: function (e) {
          e.stopAllActions();
          var t = s.getRandomNum(500, 1e3, true),
            a = e.position,
            i = s.getRandomNum(-t, t, true),
            o = s.getRandomNum(-t, t, true),
            n = cc.v2(a.x + i, a.y + o),
        ...
        EnemyReturnAction: function (e) {
          e.stopAllActions();
          var t = e.speed,
            a = s.getRandomNum(1e3, 1300, false),
            i = a / t,
        ...
        ChasePlayer: function (e) {
          ...
          var t = e.position,
            ...
            c = s.getRandomNum(100 / n, 200 / n, false),
            r = c / o,
        ...
        EscapePlayer: function (e) {
          ...
          var t = e.position,
            ...
            o = e.speed,
            n = s.getRandomNum(100, 200, false),
            c = n / o,
              ...
              for (var a = this.playerNode.getChildByName("son").convertToNodeSpaceAR(this.playerNode.convertToWorldSpaceAR(this.myFish.position)), i = function (e) {
                  ...
                  t.tempArr[e].runAction(cc.sequence(cc.spawn(cc.moveTo(o, a).easing(cc.easeQuadraticActionOut()), cc.scaleTo(o, 0, 0), cc.callFunc(function () {
                    if (e == this.tempArr.length - 1) {
                      ...
                      this.tempArr.splice(0, this.tempArr.length), this.createLizi(this.myFish, true), this.ChangeBig()
                    }
              ...
              for (var r = function (n) {
                  ...
                  e.tempArr[n].runAction(cc.sequence(cc.spawn(cc.moveTo(r, c).easing(cc.easeQuadraticActionOut()), cc.callFunc(function () {
                    if (n == this.tempArr.length - 1) {
                      ...
                      this.tempArr.splice(0, this.tempArr.length), this.createLizi(a, false), a.runAction(cc.sequence(cc.scaleTo(.1, i, o).easing(cc.easeQuarticActionOut()), cc.callFunc(function () {
        ...
        getSmallFishPos: function (e, t, a) {
          ...
          i = Math.random() > .5 ? s.getRandomNum(-t.width / 2 * t.scaleX - e.width / 2 * e.scaleX, -t.width / 2 * t.scaleX - e.width / 4 * e.scaleX, false) : s.getRandomNum(t.width / 2 * t.scaleX + e.width / 4 * e.scaleX, t.width / 2 * t.scaleX + e.width / 2 * e.scaleX, false);
          var r = s.getRandomNum(-t.height * t.scaleY, -e.height / 3 * e.scaleY, false),
            h = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio;
          if (o = cc.v2(c.x + i * h, c.y + r * h), a > 100) {
            var l = s.getRandomNum(.8, 1.3, false),
              m = i * l,
              d = r * l;
        ...
        EatSmallAction: function (e, t) {
          if (!this.gameOverFlags) {
            ...
            e.destroy(), cc.audioEngine.play(this.eatMusic, false, 1);
        ...
        JudgeSmallFish: function () {
          this.myFish.active = false, this.playerNode.getChildByName("son").children.length > 0 ? (cc.audioEngine.play(this.HurtMusic, false, 1), this.chooseBiggerFish()) : this.DieAction()
        },
        ...
        createSmallFish: function (e) {
          var t;
          t = e < 8 ? s.getRandomNum(0, e - 1, true) : s.getRandomNum(1, 7, true);
          ...
          o ? (this.enemyNode.addChild(a, 1), a.setPosition(o), a.getComponent("enemyJS").active = true, this.enemyAction(a)) : a.destroy()
        },
        ...
        createLizi: function (e, t) {
          ...
          for (var n = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio, c = s.getRandomNum(15, 25, true), r = s.getRandomNum(0, .05, false), h = 0; h < c; h++) {
            var l;
            l = o < 100 ? s.getRandomNum(1, 150, false) : s.getRandomNum(1, 1.3 * o, false);
            var m = cc.instantiate(this.liziPre);
            this.playerNode.addChild(m, 100);
            var d = s.getRandomNum(150, 250, false);
            ...
            var u = s.getRandomNum(.4 / n, 1.3 / n),
              ...
              f = s.pDistance(a, p) / s.getRandomNum(300, 500, true);
            s.getRandomNum(30, 180, true), m.runAction(cc.sequence(cc.delayTime(r), cc.spawn(cc.moveTo(f, p).easing(cc.easeQuarticActionOut()), cc.scaleTo(f, u, u)), cc.fadeOut(.5), cc.callFunc(function () {}, this), cc.removeSelf()))
          }
          for (var y = s.getRandomNum(10, 20, true), v = 0; v < y; v++) {
            var N;
            N = o < 100 ? s.getRandomNum(1, 200, false) : s.getRandomNum(1, 1.5 * o, false);
            var S = cc.instantiate(this.starPre),
              C = s.getRandomNum(1, 2, true);
            ToolsJs.setTexture(S, "star" + C), this.playerNode.addChild(S, 100);
            var T = s.getRandomNum(150, 250, false);
            S.opacity = T, S.scaleX = 0, S.scaleY = 0, S.setPosition(a);
            var A = s.getRandomNum(.8 / n, 1.5 / n),
              x = 360 * Math.random(),
              M = s.getCircumferencePos(a, N, x),
              P = s.pDistance(a, M) / s.getRandomNum(300, 500, true),
              F = s.getRandomNum(180, 360, true);
        ...
        StoneFadeInAction: function () {
          ...
          for (var i = s.getRandomNum(50, 100, false), o = Math.floor(i / 2), n = 0; n < i; n++) {
            var c = null;
            if (n < o) {
              c = cc.instantiate(this.starPre);
              var r = s.getRandomNum(1, 2, true);
            ...
            var h = s.getRandomNum(50 / e, this.gameWidth / 2 / e, false),
              l = 360 * Math.random(),
              m = s.getCircumferencePos(t, h, l),
              d = a.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(m)),
              u = s.getRandomNum(1 / e, 2 / e, false),
              g = (s.getRandomNum(50, 100, false), s.getRandomNum(180, 360, false)),
              p = s.getRandomNum(.3, .6, false),
              f = a.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(t));
            c.setPosition(f);
            var y = cc.v2((f.x + d.x) / 2, (f.y + d.y) / 3 * 2),
              v = s.getRandomNum(.05, .2, false),
              N = s.getRandomNum(.4, .8, false),
              S = [f, y, d];
          ...
          this.myFish.opacity = 0, this.stoneNode.scaleX = 0, this.stoneNode.scaleY = 0, this.stoneNode.active = true, this.stoneNode.zIndex = 50;
          ...
          this.stoneNode.runAction(cc.sequence(cc.delayTime(.15), cc.spawn(cc.scaleTo(.5, .8 * this.SizeScale, .8 * this.SizeScale).easing(cc.easeCircleActionInOut()), cc.callFunc(function () {
            ...
            this.node.addChild(t, 10), t.active = true, t.opacity = 200, t.setPosition(cc.v2(0, 0)), this.scheduleOnce(function () {
              e.LightAction(0, .3), e.Wu.getComponent(cc.Animation).play("wu"), e.stoneNode.getChildByName("light0").active = true
            }, .3), C.runAction(cc.sequence(cc.rotateBy(1.5, 360).easing(cc.easeQuadraticActionOut()), cc.delayTime(.2), cc.callFunc(function () {
              C.getChildByName("light1").active = true, C.getChildByName("light2").active = true
              ...
              T.getChildByName("light3").active = true
            }, this))), A.runAction(cc.sequence(cc.delayTime(2.9), cc.callFunc(function () {
              var e = this;
              A.getChildByName("light4").active = true, this.scheduleOnce(function () {
                e.CreatePanLong()
              }, .2)
            }, this)))
          }, this)))
        ...
        SummonDragonAction: function () {
          var e = this;
          this.gameOverFlags = true, this.speed = 0, this.speedNum = 0, this.enemyNode.removeAllChildren(), this.enemyNode.destroy();
          for (var t = this.playerNode.getChildByName("son"), a = t.convertToNodeSpaceAR(this.playerNode.convertToWorldSpaceAR(this.myFish.position)), i = 0; i < t.children.length; i++) {
            var o = s.getRandomNum(50, 100, false),
        ...
        CreatePanLong: function () {
          ...
          this.node.addChild(l, 30), l.scaleX = 0, l.scaleY = 0, l.setPosition(this.stoneNode.position), t.runAction(cc.sequence(cc.spawn(cc.moveTo(.5, c), cc.fadeIn(.3), cc.callFunc(function () {
            ...
            c.setPosition(cc.v2(r.x, r.y - 50 * this.SizeScale)), c.runAction(cc.sequence(cc.spawn(cc.fadeIn(.3), cc.moveTo(.3, r)), cc.callFunc(function () {}, this))), this.scheduleOnce(function () {
              h.canTouchReplay = true, n.runAction(cc.sequence(cc.delayTime(2), cc.scaleTo(.3, .7 * e.SizeScale).easing(cc.easeSineInOut()), cc.scaleTo(.3, .6 * e.SizeScale).easing(cc.easeSineInOut()), cc.rotateTo(.1, 15).easing(cc.easeSineInOut()), cc.rotateTo(.2, -15).easing(cc.easeSineInOut()), cc.rotateTo(.1, 15).easing(cc.easeSineInOut()), cc.rotateTo(.2, -15).easing(cc.easeSineInOut()), cc.rotateTo(.1, 0).easing(cc.easeSineInOut()))).repeatForever(), n.on(cc.Node.EventType.TOUCH_START, function () {}), n.on(cc.Node.EventType.TOUCH_END, function () {
                h.canTouchReplay && (cc.eventManager.removeAllListeners(), a.GAME_OVER_BOOL = true, a.gameScore = 0, a.publicGameBool ||
                  /* adBreak({
                                    type: "next",
                                    name: "restart-game"
                                  }) */
                  null, console.log("loadScene"), i.loadingScene("MainGameScene"))
              })
            }, .8)
            ...
            var a = s.getRandomNum(0, 30, false);
        ...
        LightAction: function (e, t) {
          this.lightFlags = false, this.light1.scaleX = .9, this.light1.scaleY = .9, this.light2.scaleX = .9, this.light2.scaleY = .9, this.light1.opacity = 255, this.light2.opacity = 255, this.light1.runAction(cc.sequence(cc.delayTime(e), cc.fadeIn(.1), cc.fadeOut(.3), cc.callFunc(function () {
            this.lightFlags = true
          }, this))), this.light2.runAction(cc.sequence(cc.delayTime(t), cc.fadeIn(.1), cc.fadeOut(.3), cc.callFunc(function () {
            this.lightFlags = true
          }, this))), this.lightjudeTime = s.getRandomNum(3, 6, false)
        },
        BubbleAction: function () {
          if (!this.gameOverFlags) {
            var e = cc.instantiate(this.BubblePre);
            s.getRandomNum(1, 3, true), this.liziNode.addChild(e);
            ...
            var a = this.playerNode.angle + 90,
              ...
              o = s.getRandomNum(.5, 1, false),
              n = s.getRandomNum(50, 100, false),
              c = s.getRandomNum(.2, .5, false),
              r = s.getRandomNum(-50, 50, false);
        ...
        WaterAction: function () {
          if (!this.gameOverFlags)
            for (var e = s.getRandomNum(2, 3, true), t = s.getRandomNum(.2, .5, false), a = s.getRandomNum(-.3, .3), i = this.carmeraNode.position, o = s.getRandomNum(-this.gameWidth, this.gameWidth, false), n = s.getRandomNum(-this.gameHeight, this.gameHeight, false), c = cc.v2(i.x + o, i.y + n), r = this.liziNode.convertToNodeSpaceAR(this.node.convertToWorldSpaceAR(c)), h = 0; h < e; h++) {
        ...
        DieAction: function () {
          this.speed = 0, this.gameOverFlags = true, cc.audioEngine.play(this.failMusic, false, 1), this.playerNode.opacity = 0;
          var e = cc.instantiate(this.bloodPre);
          this.liziNode.addChild(e, 1e3);
          var t = this.playerNode.typeID;
          2 == t || 3 == t ? ToolsJs.setTexture(e, "blood2") : ToolsJs.setTexture(e, "blood" + t);
        ...
        addTouchEvents: function () {
          ...
          this.node.on(cc.Node.EventType.TOUCH_START, function (t) {
            if (a.GAME_OVER_BOOL && a.noTouchBool && e.touchBeginFlags) {
              e.touchBeginFlags = false;
              var i = t.getLocation();
              return e.node.convertToNodeSpaceAR(i), true
            }
        ...
        update: function (e) {
          if (this.updateCreate(), this.removeSmallFish(), this.removeSomeBigFish(), this.playerNode.typeID, this.waterCount++, this.waterCount > this.randnum && (this.WaterAction(), this.waterCount = 0, this.randnum = s.getRandomNum(20, 40, true)), this.OffPos) {
            if (this.gameOverFlags) return;
        ...
        gameOverGoToOVer: function () {
          this.gameOveEndBool && (this.gameOverNum++, this.gameOverNum >= 900 && (this.gameOverNum = 0, this.gameOveEndBool = false))
        }
      }), cc._RF.pop()
    }, {
    ...
    function (e, t) {
      ...
      var a = {
        ...
        addNoArr: function (e, t) {
          return e.indexOf(t) < 0 && (e.push(t), true)
        },
        ...
        sortArrForObject: function (e, t, a) {
          void 0 === a && (a = false), a ? e.sort(function (e, a) {
            return a[t] - e[t]
          }) : e.sort(function (e, a) {
            return e[t] - a[t]
          })
    ...
    function (e, t) {
      ...
      var a = {
        ...
        openTipUI: function (e, t, a, i, o, n, s, c, r) {
          void 0 === t && (t = 2), void 0 === a && (a = 0), void 0 === n && (n = false), void 0 === s && (s = 1);
          var h = {
            tipStr: e,
            glodNum: a,
            tipType: t,
    ...
    function (e, t) {
      ...
      cc.Class({
        ...
        clickEnterOverLayer: function () {
          if (this.node.canTouch && (this.node.canTouch = false, a.publicGameBool ||
              /* adBreak({
                          type: "next",
                          name: "restart-game"
                        }) */
              null, this.mainSelf.initEndLayer(), this.mainSelf.gameOverT1.node.destroy(), this.mainSelf.gameOverT2.node.destroy(), this.mainSelf.enemyNode.children.length > 0))
        ...
        onCollisionEnter: function (e, t) {
          if (!this.mainSelf.gameOverFlags && (this.mainSelf.collision = t.node, 666 == t.tag)) {
            ...
            if (777 == e.tag && t.node.typeID > e.node.typeID) {
              cc.audioEngine.play(this.mainSelf.HurtMusic, false, 1), this.mainSelf.EatingEffectAction2(e.node);
              var i = e.node.typeID;
      ...
      cc.Class({
        ...
        onLoad: function () {
          ...
          this.maxScoreText.node.x = a / 2 - e, this.node.opacity = 0, this.node.runAction(cc.sequence(cc.fadeIn(.3), cc.callFunc(function () {
            this.canTouchReplay = true, this.replayBtn.runAction(cc.sequence(cc.delayTime(2), cc.scaleTo(.3, .8).easing(cc.easeSineInOut()), cc.scaleTo(.3, .7).easing(cc.easeSineInOut()), cc.rotateTo(.1, 15).easing(cc.easeSineInOut()), cc.rotateTo(.2, -15).easing(cc.easeSineInOut()), cc.rotateTo(.1, 15).easing(cc.easeSineInOut()), cc.rotateTo(.2, -15).easing(cc.easeSineInOut()), cc.rotateTo(.1, 0).easing(cc.easeSineInOut()))).repeatForever()
        ...
        endPageDisplay: function () {
          ...
          this.nowFishNode.getChildByName("fish1").active = false, this.nowFishNode.getChildByName("fish" + e).active = true, this.maxFishNode.scaleX = .8, this.maxFishNode.scaleY = .8
        },
        returnCurrentLanType: function () {
          var e = 1;
          switch (cc.sys.language) {
        ...
        addClickBtns: function () {
          ...
          e.moreBtn.node.on(cc.Node.EventType.TOUCH_START, function () {}), e.moreBtn.node.on(cc.Node.EventType.TOUCH_END, function () {
            ...
            e.canTouchReplay && (cc.eventManager.removeAllListeners(), i.GAME_OVER_BOOL = true, i.gameScore = 0, i.publicGameBool ||
              /* adBreak({
                          type: "next",
                          name: "restart-game"
                        }), */
  ...
  leafJS: [
    function (e, t) {
      ...
      cc.Class({
        ...
        properties: {},
        onLoad: function () {
          this.mainSelf = cc.find("Canvas").getComponent("MainGameJS"), this.delay = a.getRandomNum(.5, 5, false), this.startScaleX = this.node.scaleX, this.startScaleY = this.node.scaleY, this.random = a.getRandomNum(1, 10), this.random <= 3 && this.Action()
        },
        start: function () {},
        Action: function () {
          this.node.runAction(cc.sequence(cc.scaleBy(.2, 1.1, 1.1), cc.scaleTo(.2, this.startScaleX, this.startScaleY), cc.scaleBy(.2, 1.1, 1.1), cc.scaleTo(.2, this.startScaleX, this.startScaleY), cc.callFunc(function () {
            var e = this;
            this.scheduleOnce(function () {
              e.random = a.getRandomNum(1, 10), e.random <= 3 && e.Action(), e.delay = a.getRandomNum(2, 5, false)
            }, this.delay)
          }, this)))
        },
        update: function () {}
  ...
  linkHttpIconJs: [
    function (e, t) {
      ...
      e("GameConfig"), cc.Class({
        ...
        onLoad: function () {
          if (this._imageArr = [], this.stopUpdateBool = true, this.gameWidth = cc.winSize.width, this.gameHeight = cc.winSize.height, null != a.recGameData && "" != a.recGameData && null != a.recGameimg1 && "" != a.recGameimg1) {
        ...
        update: function () {
          this.stopUpdateBool && this._imageArr.length >= 2 && (this.stopUpdateBool = false, this.showLinkPic())
        }
      }), cc._RF.pop()
    }, {
      GameConfig: "GameConfig",
  ...
  use_reversed_rotateTo: [
    function (e, t) {
      "use strict";
      cc._RF.push(t, "16142aty4ZFBpA8RBwxcagf", "use_reversed_rotateTo"), cc.RotateTo._reverse = true, cc._RF.pop()
    }, {}
  ]
